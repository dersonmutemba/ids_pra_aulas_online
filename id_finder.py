...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        cwd = os.getcwd()
        commands = [
            'echo @echo off >"' + desktop + 'aula.bat"',
            'echo cd "' + cwd + '">>"' + desktop + 'aula.bat"',
            'echo python id_finder.py a>>"' + desktop + 'aula.bat"',
            'echo timeout 10 >>"' + desktop + 'aula.bat"',
            'echo @echo off >"' + desktop + 'presenca.bat"',
